  ...
  (b.prototype = {
    ...
    template: function () {
      return this.defaults.text
        .replace('%1$s', this.days)
        .replace('%2$s', this.hours)
        .replace('%3$s', this.minutes)
        .replace('%4$s', this.getSecondsText());
    },
    ...
    (b.defaults = {
      ...
      text:
        ...
        window.WDK_COUNTDOWN_TEXT &&
        window.WDK_COUNTDOWN_TEXT.text
          ? window.WDK_COUNTDOWN_TEXT.text
          : '%1$s %2$s %3$s %4$s',
    }),
