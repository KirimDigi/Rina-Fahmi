var WDK_NOOP_ERROR=function(){};/*! bdtUIkit 3.16.3 | https://www.getuikit.com | (c) 2014 - 2023 YOOtheme | MIT License */
(function(ge, me) {
  ...
  "use strict";
  const __ = message=>window.WDK_BDT_TEXT&&Object.prototype.hasOwnProperty.call(window.WDK_BDT_TEXT,message)?window.WDK_BDT_TEXT[message]:message;
  ...
  var Wr = {
    ...
    , bn = {
      ...
      methods: {
          async getSvg() {
              return X(this.$el, "img") && !this.$el.complete && this.$el.loading === "lazy" ? new Promise(t=>L(this.$el, "load", ()=>t(this.getSvg()))) : jr(await Rr(this.src), this.icon) || Promise.reject(__("SVG not found.", "weddingkit-pro"))
          },
          applyAttributes(t, e) {
  ...
  var ss = {
      ...
      methods: {
          t(t, ...e) {
              var i, s, n;
              let o = 0;
              return ((n = ((i = this.i18n) == null ? void 0 : i[t]) || ((s = this.$options.i18n) == null ? void 0 : s[t])) == null ? void 0 : n.replace(/%(?:(\d+)\$)?s/g, (r,a)=>e[a ? parseInt(a, 10) - 1 : o++] || "")) || ""
          }
      }
  }
  ...
  const fi = {
    ...
    , ns = {
      ...
      methods: {
          async getSvg() {
              ...
              if (!t)
                  throw __("Icon not found.", "weddingkit-pro");
              return t
          }
      }
  }
    ...
    , ga = {
      extends: Xt,
      i18n: {
          label: __("Open menu", "weddingkit-pro")
      }
  }
    , ma = {
      extends: Xt,
      i18n: {
          label: __("Close", "weddingkit-pro")
      },
      beforeConnect() {
    ...
    , va = {
      extends: Xt,
      i18n: {
          label: __("Open", "weddingkit-pro")
      }
  }
    , wa = {
      extends: Xt,
      i18n: {
          label: __("Back to top", "weddingkit-pro")
      }
  }
    , ba = {
      extends: Xt,
      i18n: {
          label: __("Next page", "weddingkit-pro")
      },
      data: {
          role: null
      }
    ...
    , $a = {
      extends: Xt,
      i18n: {
          label: __("Previous page", "weddingkit-pro")
      },
      data: {
          role: null
      }
  ...
  function Fa({modal: t}) {
      ...
      ,
      t.i18n = {
          ok: __("OK", "weddingkit-pro"),
          cancel: __("Cancel", "weddingkit-pro")
      };
      function e(i, s, n, o) {
          s = {
              bgClose: !1,
  ...
  var $l = {
      i18n: {
          next: __("Next slide", "weddingkit-pro"),
          previous: __("Previous slide", "weddingkit-pro"),
          /* translators: %s: slide number. */
          slideX: __("Slide %s", "weddingkit-pro"),
          /* translators: 1: current slide number, 2: total slide count. */
          slideLabel: __("%1$s of %2$s", "weddingkit-pro")
      },
      data: {
          selNav: !1
      },
  ...
  var eh = {
      mixins: [ss],
      i18n: {
          /* translators: %s: rejected MIME type. */
          invalidMime: __("Invalid file type: %s", "weddingkit-pro"),
          /* translators: %s: rejected file name. */
          invalidName: __("Invalid file name: %s", "weddingkit-pro"),
          /* translators: %s: maximum file size in kilobytes. */
          invalidSize: __("Invalid file size: maximum %s KB", "weddingkit-pro")
      },
      props: {
          allow: String,
          clsDragover: String,
  ...
  function nh(t, e) {
      return new Promise((i,s)=>{
          ...
          x(n, "error", ()=>s(xt(Error(__("Network Error", "weddingkit-pro")), {
              xhr: n
          }))),
          x(n, "timeout", ()=>s(xt(Error(__("Network Timeout", "weddingkit-pro")), {
              xhr: n
          }))),
          n.send(e.data)
      }
